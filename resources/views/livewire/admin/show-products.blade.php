                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th wire:click="ordenarPorVendidos" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            Vendidos
                                        </th>
                                        <th wire:click="ordenarPorPendientes" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            Pendientes
                                        </th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php $cantidadTotal2 = 0; ?>
                                            @foreach($orders as $order)
                                            <?php $items = json_decode($order->content); ?>
                                            @foreach($items as $item)
                                            @if($item->name == $product->name && $order->status == 1)
                                            
                                            <?php $cantidadTotal2 += $item->qty; ?>
